...
.test-name-box #testName{text-align: center;font-size: 20px;color: #eee;}
.select-subject-box .jeong-bo-gisa{text-align: center;}
.select-subject-box .jeong-bo-gisa a{display: inline-block;margin: 0px 10px;width: 130px;}

/* 토글 버튼 */
figure{margin-top: 40px; margin-left: 250px; display: inline-block;}
figure span{position:relative; top:-13px;}
#switchAnswer, 
#switchNote {width:65px; padding:5px; border:4px solid #2196F3; box-sizing:border-box; opacity:0.5;
			-webkit-filter:grayscale(100%); -webkit-transition:all 03s; transition:all 0.3s;border-radius:540px;cursor:pointer;
			display: inline-block; margin-right:25px;}
#switchAnswer .toggle, 
#switchNote .toggle{width:15px;height:15px; background:#2196F3; border-radius:100%; position:relative;
...
/*------------------------------ 
	문제, 보기, 정답, 오답노트 영역
------------------------------*/
.slider {width: 50%; margin: 0px auto; background:#f0f0f0;}
.slick-slide {margin: 0px 20px;}
.slick-slide img {max-width: 500px; max-height:300px;}
.slick-prev{left:-45px !important;}
.slick-prev:before, .slick-next:before {color: #fff; padding:10px;}
							...
							<div class='each-question'>
								...
								<div class="note-box" noteno="${obj.note.note_no}" tqno="${obj.tq_no}">
									<div class="note-box-inner">
										<p><label for="">풀이</label><textarea cols="100" rows="5" class="note_content" placeholder="여기에 오답 풀이 내용을 입력하세요">${obj.note.note_content}</textarea></p>
										<p><label for="">메모</label><textarea cols="100" rows="5" class="note_memo" placeholder="여기에 메모를 입력하세요">${obj.note.note_memo}</textarea></p>
